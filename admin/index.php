...
echo "<script>alert('Passwordi gabim');</script>";
 
  }
}
//if username or email not found in database
else{
echo "<script>alert('User-i nuk eshte i regjistruar me ne.');</script>";
  }
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Portal Lajmesh | Admin Panel</title>
                                ...
                                <div class="account-content">
                                    <form class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group account-btn text-center m-t-10">
                                            <div class="col-xs-12">
                                                <button class="btn w-md btn-bordered btn-danger waves-effect waves-light" type="submit" name="login">Kyçuni</button>
                                            </div>
                                        </div>
