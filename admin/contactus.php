...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Portal Lajmesh | Faqja e kontaktit</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Faqja e kontaktit  </h4>
...
<label for="exampleInputEmail1">Titulli i faqes</label>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Detajet e faqes</b></h4>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">Perditesoni dhe postoni</button>
