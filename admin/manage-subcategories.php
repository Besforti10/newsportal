...
<html lang="en">
    <head>
        ...
        <title> Portal Lajmesh | Menaxho nen-kategorite</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Menaxho nen-kategorine</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">Admin</a>
                                        </li>
                                        <li>
                                            <a href="#">Nen-kategoria </a>
                                        </li>
                                        <li class="active">
                                           Menaxho Nen-kategorite
                                        </li>
                                    </ol>
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Shto <i class="mdi mdi-plus-circle-outline" ></i></button>
</a>
 </div>
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Data e postimit</th>
                                                                  <th>Data e perditsimit të fundit</th>
                                                                <th>Veprimi</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
...
<td colspan="7" align="center"><h3 style="color:red">Nuk u gjete asnje rekord</h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Nen-kategorite e fshira</h4>
