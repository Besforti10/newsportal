...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Newsportal | Shto Postime</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Edito Postin </h4>
...
<label for="exampleInputEmail1">Titulli i Postit</label>
...
<div class="form-group m-b-20">
<label for="exampleInputEmail1">Katoegoria</label>
