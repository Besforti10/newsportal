...
if($_GET['resid'])
{
	...
	$msg="Kategoria u rikuperua me sukses";
}
...
if($_GET['action']=='parmdel' && $_GET['rid'])
{
	...
	$delmsg="Kategoria eshte fshijer pergjithmon";
}
...
<html lang="en">
    <head>
        ...
        <title> Portal Lajmesh | Menaxho Kategorite</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Menaxho Kategorite</h4>
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Kategorite e fshira</h4>
