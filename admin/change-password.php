...
{
$error="Fjalëkalimi i vjetër nuk përputhet !!";
}
}
...
<html lang="en">
    <head>
        ...
        <title>Portal Lajmesh | Shto kategorine</title>
...
{
alert("Fjalëkalimi aktual i regjistruar është bosh !!");
document.chngpwd.password.focus();
return false;
}
else if(document.chngpwd.newpassword.value=="")
{
alert("Fjalëkalimi i ri i regjistruar është bosh !!");
document.chngpwd.newpassword.focus();
return false;
}
else if(document.chngpwd.confirmpassword.value=="")
{
alert("Konfirmimi i Fjalëkalimit te paraqitur është Bosh !!");
document.chngpwd.confirmpassword.focus();
return false;
}
else if(document.chngpwd.newpassword.value!= document.chngpwd.confirmpassword.value)
{
alert("Fusha e Fjalëkalimit dhe Konfirmimit të Fjalëkalimit nuk përputhen  !!");
document.chngpwd.confirmpassword.focus();
return false;
}
return true;
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Ndrysho fjalekalimin</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Ndrysho fjalekalimin </b></h4>
                                    <hr />
...
<label class="col-md-4 control-label">Fjalekalimi aktual:</label>
<div class="col-md-8">
...
<div class="form-group">
<label class="col-md-4 control-label">Fjalekalimi i ri:</label>
<div class="col-md-8">
