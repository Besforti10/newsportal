...
<html lang="en">
    <head>
        ...
        <title>Portal Lajmesh | Add Category</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Edito Kategorine</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Edito Kategorine </b></h4>
                                    <hr />
...
<strong>Te lumte!</strong> <?php echo htmlentities($msg);?>
</div>
<?php } ?>
                        			...
                        			<div class="row">
                        				<div class="col-md-6">
                        					<form class="form-horizontal" name="category" method="post">
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">Pershkrimi i kategorise</label>
	                                                <div class="col-md-10">
