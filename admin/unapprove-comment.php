...
if($_GET['action']=='del' && $_GET['rid'])
{
	...
	$delmsg="Kategoria u fshi përgjithmonën";
}
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Menaxho komentet e pa aprovuara</h4>
...
<td>
<?php if($st=='0'):?>
    <a href="unapprove-comment.php?disid=<?php echo htmlentities($row['id']);?>" title="Mos e prano këtë koment"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php else :?>
  <a href="unapprove-comment.php?appid=<?php echo htmlentities($row['id']);?>" title="Miratoni këtë koment"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php endif;?>
